...
{
    public class DestinationAddressConfiguration : IEntityTypeConfiguration<DestinationAddress>
    {
        public void Configure(EntityTypeBuilder<DestinationAddress> builder)
        {
            // Primary Key
